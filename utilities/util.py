...
class Util(object):
    ...
    def sleep(self, sec, info=""):
        ...
        :param sec: Time in seconds, what program should wait
        :param info:
        :return:
        """
        if info is not None:
    ...
    def getAlphaNumeric(self, length, type="letters"):
        ...
        :param type: Type of characters string should have. Default is 'letters'. Provide lower/upper/digits for different types
        :return:
        """
        alpha_num = ''
        if type == 'lower':
